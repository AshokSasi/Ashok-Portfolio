...
function DisplayServicesPage(req, res, next) {
    res.render('index', { title: 'My Skills', page: 'skills', displayName: index_1.UserDisplayName(req) });
}
exports.DisplayServicesPage = DisplayServicesPage;
function DisplayProjectsPage(req, res, next) {
    res.render('index', { title: 'My Projects', page: 'projects', displayName: index_1.UserDisplayName(req) });
}
